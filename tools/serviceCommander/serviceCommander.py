...
def mastercommand(debug, logfile, services, subset, inventory_file, cluster, restart, start, stop, force_stop, clean, install, configure, ansible_root_dir, max_retries):
  if debug:
