...
$ROOT/docker/scribengin/docker.sh cluster --clean-containers --run-containers --kafka-server=6  --monitoring-server=0 --ansible-inventory --deploy --start --neverwinterdp-home=$NEVERWINTER_HOME
