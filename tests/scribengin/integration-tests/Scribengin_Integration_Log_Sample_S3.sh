...
ssh -o "StrictHostKeyChecking no" neverwinterdp@hadoop-master "cd /opt/neverwinterdp && ./dataflow/log-sample/bin/run-s3.sh --profile=performance --message-generator=4 --num-of-message=2500000 --message-size=512"
