...
ssh -o "StrictHostKeyChecking no" neverwinterdp@hadoop-master "cd /opt/neverwinterdp/ &&     \
                              ./dataflow/log-sample/bin/run-dataflow-chain.sh --num-of-message=1000000  --generator-max-wait-time=10000 \ 
                              --generator-send-period=1  --max-run-time=604800000 --junit-report junit-reports/ScribenginKafkaFailureStability.xml"
