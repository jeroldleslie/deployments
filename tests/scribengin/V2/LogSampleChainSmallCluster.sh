...
GENERATOR_OPTS="--generator-max-wait-time=10000 --generator-send-period=1"
...
DATAFLOW_OPTS="$STORAGE_OPTS --dedicated-executor=false --num-of-worker=8 --num-of-executor-per-worker=2 --num-of-stream=8 --num-of-message=180000000 --message-size=512 $KILL_WORKER_OPTS"
