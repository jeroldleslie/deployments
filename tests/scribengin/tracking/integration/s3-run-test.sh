...
DATAFLOW_STORAGE=$(get_opt --dataflow-storage 's3' $@)
...
GENERATOR_OPTS="\
  --generator-num-of-chunk=10 --generator-num-of-message-per-chunk=100 --generator-num-of-writer=1 --generator-break-in-period=50 \
