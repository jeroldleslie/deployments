...
DATAFLOW_OPTS="--dataflow-storage hdfs --dataflow-num-of-worker 8 --dataflow-num-of-executor-per-worker 2 --dataflow-tracking-window-size 5000 --dataflow-sliding-window-size 100"
