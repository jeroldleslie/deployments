...
$serviceCommander -i $INVENTORY --cluster --configure --profile-type=consolidated
...
GENERATOR_OPTS="\
  --generator-num-of-chunk 60 --generator-num-of-message-per-chunk 100000000 --generator-num-of-writer 1 --generator-break-in-period 125 \
  --generator-kafka-num-of-partition 2 --generator-kafka-num-of-replication 1 \
...
DATAFLOW_OPTS="\
  --dataflow-storage $TEST_STORAGE --dataflow-num-of-worker 2 --dataflow-num-of-executor-per-worker 2 \
  --dataflow-tracking-window-size 50000 --dataflow-sliding-window-size 100 \
  --dataflow-default-parallelism 2 --dataflow-default-replication 1"
