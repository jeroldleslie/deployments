...
INVENTORY="/home/neverwinterdp/inventory"
...
GENERATOR_OPTS="\
  --generator-num-of-chunk=100 --generator-num-of-message-per-chunk=50000000 --generator-num-of-writer=1 --generator-break-in-period=30 \
